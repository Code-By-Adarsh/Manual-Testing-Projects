...
* Covering complete E-commerce workflow
...
| ------------ | -------------------------------------------- | --------------------------------------------- | ------------------------------------------ | ------ |
| TC_01        | Verify user can login with valid credentials | Enter valid username & password → Click Login | User should be redirected to Products page | Pass   |
